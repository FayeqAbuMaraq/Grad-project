...
<body  class="page-signup">
    ...
    <div class="container d-flex justify-content-center">
        <div class="card auth-card p-4 w-100 reveal">
            ...
            <p class="text-muted text-center mb-4" style="font-weight: 300px;">أدخل بياناتك لإنشاء حساب جديد</p>
            ...
            <form method="POST" action="{{ route('register') }}" class="signupForm">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-icon-wrapper">
                        <input id="name" class="form-control" type="text" name="name" required placeholder="مثال: أحمد محمد" />
            ...
            <div class="text-center mt-3">
                <p class="mb-0" style="font-size: 0.95rem;">لديك حساب بالفعل؟ <a href="{{ route('login')}}"
                        class="text-primary fw-bold">تسجيل الدخول</a></p>
            </div>
