        ...
        <div class="test-item reveal">
          <div class="test-content">
            ...
            <div class="test-meta-line">
              ...
              <span>{{ $exam->subject->grade->name }}</span>
              <span>{{ $exam->questions_count }} سؤال</span>
            </div>
            <div class="test-date"><i class="bi bi-clock"></i> {{ $exam->created_at->format('Y/m/d') }}</div>
          </div>
        </div>
        @endforeach
      </div>
  ...
  <div class="col-lg-4 order-lg-2">
    <div class="card-box reveal">
      ...
      <div class="subject-list">
        ...
        <div class="subject-item reveal">
          <div class="subject-icon blue"><i class="bi bi-book"></i></div>
          <div class="subject-content">
            <h6>{{ $subject->name }}</h6>
            <small>{{ $subject->grade->name }}</small>
