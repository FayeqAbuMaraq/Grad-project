    ...
    <div class="container">
      ...
      <div class="row g-4 align-items-stretch">
        ...
        <div class="col-lg-7">
          <div class="result-card reveal h-100">
            <h6 class="section-title">مراجعة الأسئلة</h6>
            <div class="stat-item">
              <div class="stat-title">النسبة</div>
              <div class="stat-bar">
            ...
            <div class="stat-item">
              <div class="stat-title">الاجوبة الصحيحة</div>
              <div class="stat-bar">
            ...
            <div class="stat-item">
              <div class="stat-title">الاجوبة الخاطئة</div>
              <div class="stat-bar">
      ...
      <section class="review-card reveal mt-4">
        ...
        <div class="review-actions">
          <button class="btn btn-light">إعادة المحاولة</button>
